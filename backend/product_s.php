                    ...
                    <form method="GET" class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label" for="class_id">產品名稱</label>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label" for="class_id">產品類別</label>
                                <select name="product_class" id="product_class" class="form-control input-sm">
                                    <?php
                                        $strSQL = "SELECT * FROM product_class ORDER BY sort desc";
                                        $product_class = $db->Execute($strSQL);
                                        echo '<option value="" >全部</option>';
                                        foreach ($product_class as$product_classs):
                                        echo' <option value="'.$product_classs['id'].'" '.(($_GET['product_class']==''.$product_classs['id'].'' && $_GET['product_class']!='')?'selected':'').' >'.$product_classs['title'].'</option> ';
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="javascript:void(0);" onclick="changeon('chk','product','status')">啟用</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="changeoff('chk','product','status')">不啟用</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="batchdelete('chk','product')">刪除</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        if (is_array($arr_data)):
                            foreach ($arr_data as $kk => $data)
                            {
                                ...
                                <tr class="vertical-md-middle <?=($page_tmp!='')?'unsortable':''?>" id="n_<?=$data['id']?>">
                                            ...
                                            <td class="text-center">
                                                <a  onchange="changesort(<?= $data['id'] ?>,'product')"><?=$sort?></a>
                                            </td>
                                            <!-- <td class="form-inline hidden-xs text-center" data-value="<?=$sort?>">                            <input type="text" id="sort_<?=$data['id']?>" class="form-control input-sm" value="<?=$sort?>" size="2" onchange="changesort(<?= $data['id'] ?>,'product')">
                                            </td> -->
                                            <td class="text-center">
                                            <?php
                                                if($data['status']==1){
