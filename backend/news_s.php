            ...
            <div class="card">                
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <p class="text-left">
                                <a href="<?='news_class.php'?>" 
                                ><button type="button" class="btn btn-primary">
                                    <i class="fa fa-chevron-left"></i> 回上頁
                                </button></a>
                            </p>
                            <div class="row">
                                <div class="dropdown">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="javascript:void(0);" onclick="changeon('chk','news','status')">啟用</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="changeoff('chk','news','status')">不啟用</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="batchdelete('chk','news')">刪除</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 text-right">
                            <a href="<?=$func_page . '.php?func=insert'?>">
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="hidden-xs text-center">發布日期</th>
                            ...
                            <?php
                                ...
                                <tr class ="unsortable">
                                    ...
                                    <td class="text-center">
                                        <a href="#" onclick="upd1(<?= $data['id'] ?>);
                                                return false;"><?= $title ?></a>
                                    </td>
                                    <td class="text-center">                                                
                                        <?=date('Y-m-d',$create_date)?>
                                    </td>
                                    <td class="text-center">
                                    <?php
                                        if($data['status']==1){
