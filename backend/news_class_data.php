...
switch ($_GET['func']):
    case "update":
        $news_class_id = $_GET['id'];
        $strSQL = "SELECT * FROM news_class WHERE id = '$news_class_id'";        
        ...
        if($_POST['flag'] == 'true'){
            ...
            $a = $db->update('news_class',$data,"id = '$news_class_id'");
            if(!$a){
    ...
    case "delete":
        ...
        $db->delete('news_class',"id='$news_class_id'");
        Func::go_to($func_page . '.php');
        exit;
        break;
    case "insert":
    ...
    default:
        ...
        $strSQL = "SELECT * FROM news_class WHERE 1 $andSQL ORDER BY sort desc";
        // echo $strSQL;
        // exit;
