                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="javascript:void(0);" onclick="changeon('chk','baby_card','status')">啟用</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="changeoff('chk','baby_card','status')">不啟用</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="batchdelete('chk','baby_card')">刪除</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                                ...
                                foreach ($arr_data as $kk => $data)
                                {
                                    ...
                                    $baby_name = htmlspecialchars($data['baby_name']);
                                ?>
                                <tr class ="unsortable">
                                    ...
                                    <td class="text-center">
                                        <a href="#" onclick="upd(<?= $data['id'] ?>);
                                                return false;"><?= $seccode ?></a>
                                    </td>            
                                    <td class="text-center">
                                        <a href="#" onclick="upd(<?= $data['id'] ?>);
                                                return false;"><?= $baby_name ?></a>
                                    </td>                        
                                    <td class="text-center">
