                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="javascript:void(0);" onclick="changeon('chk','qa','status')">啟用</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="changeoff('chk','qa','status')">不啟用</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="batchdelete('chk','qa')">刪除</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                                ...
                                <tr class="vertical-md-middle" id="n_<?=$data['id']?>">
                                    ...
                                    <td class="text-center">
                                        <a  onchange="changesort(<?= $data['id'] ?>,'qa')"><?=$sort?></a>
                                    </td>
                                    <!-- <td class="form-inline hidden-xs text-center">                                                
                                        <input type="text" id="sort_<?=$data['id']?>" class="form-control input-sm" value="<?=$sort?>" size="2" maxlength="2" onchange="changesort(<?= $data['id'] ?>,'qa')">
                                    </td> -->
                                    <td class="text-center">
                                    <?php
                                        if($data['status']==1){
