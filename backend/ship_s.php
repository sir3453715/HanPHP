                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="javascript:void(0);" onclick="changeon('chk','ships','status')">啟用</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="changeoff('chk','ships','status')">不啟用</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="batchdelete('chk','ships')">刪除</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="hidden-xs text-center">運費</th>
...
if (is_array($arr_data)):
    foreach ($arr_data as $kk => $data) {
        $id = $data['id'];
        $ship = $data['ship'];
        $min_num = htmlspecialchars($data['min_num']);
        $max_num = htmlspecialchars($data['max_num']);
        ?>
	                                <tr class ="unsortable">
	                                    <td class="text-center">
	                                        <a><?=$min_num . " ~ " . $max_num . "個"?></a>
	                                    </td>
	                                    <td class="text-center">
